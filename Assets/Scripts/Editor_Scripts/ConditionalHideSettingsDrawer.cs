...
public class ConditionalHideSettingsDrawer : PropertyDrawer
{
    ...
    {
        ConditionalHideSettings condHAtt = (ConditionalHideSettings)attribute;
        bool enabled = GetConditionalHideSettingsResult(condHAtt, property);        
    ...
    bool GetConditionalHideSettingsResult(ConditionalHideSettings condHAtt, SerializedProperty property)
    {
    ...
    bool CheckPropertyType(ConditionalHideSettings condHAtt, SerializedProperty sourcePropertyValue)
    {
